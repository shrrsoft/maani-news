      ...
      <div className=" md:grid grid-cols-3 gap-4 md:w-full w-[90%] mx-auto ">
        {data.map((item) => (
          <Link href={`/News/${item.id}`} className="col-span-2">
            <div
              key={item.id}
              className="bg-slate-100 shadow-md border text-center md:text-right p-1 py-2 md:flex gap-2 col-span-2 m-1 md:my-0 my-5">
              <div className="relative h-32 w-48 rounded-sm overflow-hidden mx-auto mb-2">
