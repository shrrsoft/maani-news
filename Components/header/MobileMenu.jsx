...
const MobileMenu = ({ locale }) => {
  ...
  return (
    <div className="bg-sky-900 pb-1 lg:hidden">
      <div
        className={`bg-slate-800/90  h-screen fixed z-20 left-0 top-10 overflow-hidden origin-left transition-all ease-in-out ${
          isOpen ? "w-72" : "w-0"
        }`}
        ...
        <div className="flex flex-col gap-1 items-center p-1 text-white ">
          ...
          <div className="w-40 h-0.5 bg-gradient-to-r from-white/10 via-white to-white/20"></div>
          <Link
            className={clsx("text-center py-3", {
              "text-center bg-white/30 text-white rounded-sm w-72":
                pathname === "/Politics",
            })}
            href="/Politics">
            {t("Politics")}
      ...
      <div className="bg-white pt-16 pb-2 flex justify-around items-center flex-col ">
