    ...
    <div className="bg-sky-900 pb-1 lg:hidden">
      <div
        ...
        <div className="flex flex-col gap-1 items-center p-1 text-white ">
          ...
          <Link
            className={clsx("text-center text-2xl py-3", {
          ...
          <Link
            className={clsx("text-center text-2xl py-3", {
              "bg-white/30 text-white rounded-full w-72": pathname === "/Economy",
            })}
            href="/Economy">
            {t("Economy")}
          </Link>
          ...
          <Link
            className={clsx("text-center text-2xl py-3", {
              "bg-white/30 text-white rounded-full w-72": pathname === "/Culture",
            })}
            href="/Culture">
            {t("Culture")}
          </Link>
          ...
          <Link
            className={clsx("text-center text-2xl py-3", {
              "bg-white/30 text-white rounded-full w-72": pathname === "/Social",
            })}
            href="/Social">
            {t("Social")}
          </Link>
